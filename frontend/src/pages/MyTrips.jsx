...
import { CalendarDays, CheckSquare, Eye, Luggage, PlusCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Button as={Link} to="/trips/new" className="w-full sm:w-auto">
      ...
      {trips.length === 0 ? (
        <EmptyState
          icon={Luggage}
          title="No trips yet"
          description="Create your first Traveloop trip and it will appear here with itinerary and checklist shortcuts."
